'''XiaoHongShu media handler module.'''
...
patterns = (
    r'https?:\/\/xhslink\.com\/a\/\w+',
    r'https?:\/\/(?:www\.)?xiaohongshu\.com\/explore\/\w+', # Maybe check for xsec_token?
    r'https?:\/\/(?:www\.)?xiaohongshu\.com\/discovery\/item\/\w+', # Same as above
)
